				...
				<form action="#" id="my-form">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<input type="hidden" name="id" value="<?= encrypt_url($user->user_id); ?>">
							<div class="form-group">
								<label for="nama_lengkap">Nama Lengkap</label>
								<input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Masukan Nama Lengkap" value="<?= $user->nama_lengkap; ?>">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="nip" name="nip" placeholder="Masukan NIP/NRP/Kode" value="<?= $user->nip; ?>">
						...
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								if(!empty($jabatan)){
									...
									echo form_dropdown('jabatan', $list_fix, encrypt_url($user->id_jabatan), ['class' => 'form-control jabatan', 'id' => 'jabatan']);
									}
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								echo form_dropdown('level', $option, $user->level, ['class' => 'form-control', 'id' => 'level']);

...
class Ion_auth
{
	...
	public function is_pegawai($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('is_pegawai');

		$pegawai_group = $this->config->item('pegawai_group', 'ion_auth');

		return $this->ion_auth_model->in_group($pegawai_group, $id);
	}
